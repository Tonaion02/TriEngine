...
Player::Player(const std::string& fileName)
{
	...
	player->posImage.x = player->pos.x * GeneralOptions::getTileWidht() + (GeneralOptions::getTileWidht() / 2);
	player->posImage.y = player->pos.y * GeneralOptions::getTileHeight() + (GeneralOptions::getTileHeight() / 2);

	player->item = PcrItem(0, "", TypePcrItem::NullTypePcrItem);

	//player->movingAnimation[0] = (DinamicAnimation({ "../triEngine-data/data/images/surfer.png" , "../triEngine-data/data/images/surfForBlit2.png" }, 0.5f, player->posImage, 2, 1.0f, { 0, (int)-GeneralOptions::getTileHeight() }));
	//player->movingAnimation[1] = (DinamicAnimation({ "../triEngine-data/data/images/surfer.png" , "../triEngine-data/data/images/surfForBlit2.png" }, 0.5f, player->posImage, 2, 1.0f, { 0, (int)GeneralOptions::getTileHeight() }));
	//player->movingAnimation[2] = (DinamicAnimation({ "../triEngine-data/data/images/surfer.png" , "../triEngine-data/data/images/surfForBlit2.png" }, 0.5f, player->posImage, 2, 1.0f, { (int)-GeneralOptions::getTileWidht() , 0 }));
	//player->movingAnimation[3] = (DinamicAnimation({ "../triEngine-data/data/images/surfer.png" , "../triEngine-data/data/images/surfForBlit2.png" }, 0.5f, player->posImage, 2, 1.0f, { (int)GeneralOptions::getTileWidht(), 0 }));
	
	player->movingAnimation = std::vector<DinamicAnimation>(4);
	player->movingAnimation[0] = (DinamicAnimation({ "../triEngine-data/data/images/pg.png" , "../triEngine-data/data/images/pg.png" }, 0.5f, player->posImage, 2, 1.0f, { 0, (int)-GeneralOptions::getTileHeight() }));
	player->movingAnimation[1] = (DinamicAnimation({ "../triEngine-data/data/images/pg.png" , "../triEngine-data/data/images/pg.png" }, 0.5f, player->posImage, 2, 1.0f, { 0, (int)GeneralOptions::getTileHeight() }));
	player->movingAnimation[2] = (DinamicAnimation({ "../triEngine-data/data/images/pg.png" , "../triEngine-data/data/images/pg.png" }, 0.5f, player->posImage, 2, 1.0f, { (int)-GeneralOptions::getTileWidht() , 0 }));
	player->movingAnimation[3] = (DinamicAnimation({ "../triEngine-data/data/images/pg.png" , "../triEngine-data/data/images/pg.png" }, 0.5f, player->posImage, 2, 1.0f, { (int)GeneralOptions::getTileWidht(), 0 }));
